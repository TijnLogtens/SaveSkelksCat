	...
	public class ResultScreen {  
		...
		public static void main(String[] args) {
			...
			scoreLabel1 = new JLabel(" -Score: ");
				scoreLabel1.setBounds(73, 100, 100, 50);
				scoreLabel1.setFont(label.getFont().deriveFont(20f)); 
			
			//Score getter
			scoreLabel2 = new JLabel(GraphGame.getScore());
				scoreLabel2.setBounds(200, 100, 100, 50);
				scoreLabel2.setFont(label.getFont().deriveFont(20f));
			...
			//Timer getter
			timeLabel2 = new JLabel(GraphGame.getTimer());
			...
			// Game mode getter
			modeLabel2 = new JLabel(GraphGame.getScore());
