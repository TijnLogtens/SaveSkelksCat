...
public class ResultScreen {
	...
	public static JLabel chromaticLabel1;
	public static JLabel timeLabel2;
	public static JLabel amountLabel1;
	...
	public static void ResultScreen(){
		...
		chromaticLabel1 = new JLabel("Chromatic number: ");
			chromaticLabel1.setBounds(15, 150, 200, 50);
			chromaticLabel1.setFont(label.getFont().deriveFont(20f));
			
		amountLabel1 = new JLabel("Amount of colors selected: ");
			amountLabel1.setBounds(15, 200, 300, 50);
			amountLabel1.setFont(label.getFont().deriveFont(20f));
		...
		modeLabel1 = new JLabel("Game mode: ");
			modeLabel1.setBounds(15, 225, 250, 100);
		...
		panel1.add(label);
		frame.add(chromaticLabel1);
		frame.add(timeLabel2);
		frame.add(amountLabel1);
