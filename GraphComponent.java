...
public class GraphComponent extends JComponent {
  private boolean nodeNumbersOn = false;
  ...
  private final int BOUNDARY_END = 950;// This denotes the rightmost or downmost pixel of the boundary within which we want the graph to appear
  private Graph graph;
