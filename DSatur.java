...
public class DSatur {
	...
	public DSatur(ColEdge[] edge, int numNodes ) throws Exception {
		this.edge = edge;
	...
	public int compute(ColEdge[] edge, HashMap <Integer, Integer> saturation, HashMap <Integer, Integer> colours ) throws Exception {
	...
	public void assignNumEdges(HashMap <Integer, Integer> numEdges, ColEdge[] edge) throws Exception {
	...
	public void initiateSaturation(HashMap <Integer, Integer> saturation, int numNodes) throws Exception {
		for(int i=1; i<=numNodes; i++) {
			checkTime();
			saturation.put(i, 0);
			numEdges.put(i, 0);
